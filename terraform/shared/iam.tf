...
# Note: The terraform-thoth service account has roles/run.admin granted via gcloud
# which includes run.services.setIamPolicy for managing Cloud Run IAM bindings
